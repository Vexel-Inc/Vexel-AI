...
const GOOGLE_API_KEY = "AIzaSyAcpCYCm1n8637RY-NwGhroDc_yxQl2m7I";
...
const loadSavedChatHistory = () => {
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <ion-icon name="person-circle-outline" id="userIcon"></ion-icon>
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/gemini.svg" alt="Gemini avatar" data-loader="true">
...
const displayLoadingAnimation = () => {
    const loadingHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="Images/gemini.svg" alt="Gemini avatar">
            <p class="message__text"></p>
